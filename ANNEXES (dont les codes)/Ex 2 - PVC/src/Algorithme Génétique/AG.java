...
public class AG {
	...
	public static void main(String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
	      ...
	      ArrayList<City> Cities = Simulation.initVilles((int)Taille);
	      
	      ArrayList<City> Cities2 =  (ArrayList<City>) Cities.clone();
	      Collections.shuffle(Cities2);
	      
	       Route r1 = new Route(Cities);
	       Route r2 = new Route(Cities2);
	       Couple C = new Couple(r1,r2);
	       Couple D = croisement_PMX(C);
	       System.out.println(D.getR1().toString() + "    " + D.getR2().toString());
	       }
