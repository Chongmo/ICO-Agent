    ...
    class behave extends Behaviour {
        ...
        private void init() {
            ...
            if(acl1!=null) {
                ...
                switch(s) {
                case("Tabou"):this.algorithme=new Tabou(new Route(acl1.getContent()));break;
                case("Recuit"):this.algorithme=new Recuit(new Route(acl1.getContent()));break;
                case("Genetic"):this.algorithme=new GeneticAlgorithm(new Route(acl1.getContent()));break;
